...
export const INDUSTRIES = [
  ...
  { num: '02', name: 'Healthcare',          tag: 'PATIENT MANAGEMENT\n& HEALTH ANALYTICS', g1: '#050d1e', g2: '#2d8bce', gx: '60% 38%' },
  { num: '03', name: 'BPO & Call Centers',  tag: 'WORKFORCE AUTOMATION\n& CALL ANALYTICS', g1: '#060e22', g2: '#2d6acf', gx: '65% 35%' },
  { num: '04', name: 'Hospitality',         tag: 'GUEST EXPERIENCE\n& PROPERTY MANAGEMENT', g1: '#04080f', g2: '#163f7c', gx: '68% 32%' },
  { num: '05', name: 'Legal & Financial',   tag: 'COMPLIANCE AUTOMATION\n& FINTECH SOLUTIONS', g1: '#05091c', g2: '#1d5fc4', gx: '55% 42%' },
  { num: '06', name: 'Retail & E-commerce', tag: 'OMNICHANNEL PLATFORM\n& CUSTOMER ANALYTICS', g1: '#050c1e', g2: '#1b53c8', gx: '62% 30%' },
  { num: '07', name: 'Manufacturing',       tag: 'SMART FACTORY\n& IoT INTEGRATION',      g1: '#050d1e', g2: '#2378b5', gx: '70% 25%' },
  { num: '08', name: 'IT & Technology',     tag: 'DEVOPS AUTOMATION\n& PRODUCT ENGINEERING', g1: '#060c1a', g2: '#2559a8', gx: '66% 34%' },
];
