...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const BRAND_COLORS = [
      {r:0.106,g:0.227,b:0.545},{r:0.082,g:0.337,b:0.753},{r:0.220,g:0.741,b:0.973},
      {r:0.000,g:0.788,b:0.694},{r:0.157,g:0.647,b:0.878},
    ];
    function generateColor() {
      const base=BRAND_COLORS[Math.floor(Math.random()*BRAND_COLORS.length)];
      return {r:base.r*0.35,g:base.g*0.35,b:base.b*0.35};
    }
